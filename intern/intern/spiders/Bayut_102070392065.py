...
class Bayut102070392065Spider(scrapy.Spider):
    name = "Bayut-102070392065"
    ...
    def parse(self, response):
        ...
        # Extract price from the header info container which contains Price, Location, Bed/Bath
        # The specific span selector was failing.
        header_info = soup.select_one('html > body > div:nth-of-type(1) > main > div:nth-of-type(2) > div:nth-of-type(4) > div:nth-of-type(1)')
        price = self.extract_price(self.get_text(header_info))
        ...
        amenities = self.get_text(soup.select_one('html > body > div:nth-of-type(1) > main > div:nth-of-type(2) > div:nth-of-type(4) > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(1) > div:nth-of-type(1)'))
